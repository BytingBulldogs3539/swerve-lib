...
/**
 * Additional Sds module configuration parameters.
 * <p>
 * The configuration parameters here are used to customize the behavior of the Sds swerve module.
 * Each setting is initialized to a default that should be adequate for most use cases.
 */
public class SdsModulePowerConfiguration {
    ...
    public boolean equals(Object o) {
        ...
        SdsModulePowerConfiguration that = (SdsModulePowerConfiguration) o;
