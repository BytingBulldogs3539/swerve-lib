...
public final class Mk3SwerveModuleHelper {
    ...
    public static SwerveModule createFalcon500(
        ...
        return new SwerveModuleFactory<>(
                ...
                driveMotorCanbus,
                new Falcon500SteerConfiguration<>(
                        steerMotorPort,steerMotorCanbus,
    ...
    public static SwerveModule createFalcon500(
        ...
        return createFalcon500(container, new Mk3ModuleConfiguration(), gearRatio, driveMotorPort, driveMotorCanbus, steerMotorPort,steerMotorCanbus, steerEncoderPort,steerEncoderCanbus, steerOffset);
    }
    ...
    public static SwerveModule createFalcon500(
        ...
        return createFalcon500(new Mk3ModuleConfiguration(), gearRatio, driveMotorPort, driveMotorCanbus, steerMotorPort, steerMotorCanbus, steerEncoderPort, steerEncoderCanbus, steerOffset);
    }
    ...
    public static SwerveModule createFalcon500Neo(
        ...
        return createFalcon500Neo(container, new Mk3ModuleConfiguration(), gearRatio, driveMotorPort, driveMotorCanbus, steerMotorPort, steerEncoderPort, steerEncoderCanbus, steerOffset);
    }
    ...
    public static SwerveModule createFalcon500Neo(
        ...
        return createFalcon500Neo(new Mk3ModuleConfiguration(), gearRatio, driveMotorPort, driveMotorCanbus, steerMotorPort, steerEncoderPort, steerEncoderCanbus, steerOffset);
    }
    ...
    public static SwerveModule createNeoFalcon500(
        ...
        return createNeoFalcon500(container, new Mk3ModuleConfiguration(), gearRatio, driveMotorPort, steerMotorPort, steerMotorCanbus, steerEncoderPort,steerEncoderCanbus, steerOffset);
    }
    ...
    public static SwerveModule createNeoFalcon500(
        ...
        return createNeoFalcon500(new Mk3ModuleConfiguration(), gearRatio, driveMotorPort, steerMotorPort, steerMotorCanbus, steerEncoderPort, steerEncoderCanbus, steerOffset);
    }
